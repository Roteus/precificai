import { Sector } from '../utils/types.js';
import { calculateCostBreakdown, calculateFinalPrice, getSuggestedMargin, calculateMarkup } from '../utils/calculator.js';
...
export class PricingService {
    ...
    calculatePricing(request) {
        ...
        const costBreakdown = calculateCostBreakdown(request.rawMaterials, request.utilities, request.labor || 0, request.packaging || 0, request.taxes || 0, request.fixedCosts || 0);
